...
// throwing, and the shell must expose exactly ten routed views. This is the
// guard that catches a module-top null-dereference when the markup changes.
test('app.js boots without throwing and finds 10 views', async () => {
  ...
  assert.equal(window.document.querySelectorAll('[data-view]').length, 10);
});

...
test('VIEW_NAMES is the 9-entry array with composer preserved (C1)', () => {
  assert.match(js, /const VIEW_NAMES = \['new', 'running', 'history', 'composer', 'workspaces', 'workspace-create', 'agents', 'agent-create', 'settings'\];/);
});

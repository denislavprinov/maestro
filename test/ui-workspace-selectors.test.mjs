...
test('VIEW_NAMES keeps composer + workspaces and includes the projects view (C1)', () => {
  assert.match(js, /const VIEW_NAMES = \['new', 'running', 'history', 'projects', 'composer', 'workspaces', 'workspace-create', 'settings'\];/);
});

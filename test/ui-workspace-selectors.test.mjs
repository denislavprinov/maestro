...
test('VIEW_NAMES is the 7-entry array with composer preserved (C1)', () => {
  assert.match(js, /const VIEW_NAMES = \['new', 'running', 'history', 'composer', 'workspaces', 'workspace-create', 'settings'\];/);
});

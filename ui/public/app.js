...
// ---- Inline "add project" (Step 1) -----------------------------------------
// Register a brand-new project from inside the wizard so the user is not forced
// to leave for New Pipeline. POSTs /api/projects (same endpoint as the projects
// page), refreshes state.projects from the response, auto-selects the new path,
// and re-renders. A path that does not exist yet is added but kept unselected.

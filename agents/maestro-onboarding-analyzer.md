...
Your final message reports: whether graphify succeeded (or how many retries / whether degraded), where the summary and `graphify-out/` were written, and a 3–5 sentence project understanding. On a workspace fan-out, write one summary per member project.
